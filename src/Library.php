        ...
        if (!$this->app->request->isCli()) {
            ...
            $this->app->middleware->add(function (Request $request, \Closure $next) use ($issess, $notapi) {
                ...
                if (($origin = $request->header('origin', '*')) !== '*') {
                    ...
                    $header['Access-Control-Allow-Headers'] = 'Authorization,Content-Type,If-Match,If-Modified-Since,If-None-Match,If-Unmodified-Since,X-Requested-With,User-Form-Token,User-Token,Token,Api';
                    $header['Access-Control-Expose-Headers'] = 'User-Form-Token,User-Token,Token,Api';
